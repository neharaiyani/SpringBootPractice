...
import com.codingshots.jpa_advanced.entity.Review;
...
//			deleteCourse(appDAO);
			...
			/*** New Code for Review Table (Course -> Review Uni-directional) ***/

			// create course + reviews
//			createCourseAndReviews(appDAO);

			// find course + reviews (using JOIN FETCH)
//			retrieveCourseAndReviews(appDAO);

			// delete course + reviews (using previous delete method of Course class)
